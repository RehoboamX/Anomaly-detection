...
class NormalDataset(Dataset):
    ...
    def _get_image_files(self, path, ext={'.jpg', '.png'}):
        ...
        for root, dirs, files in os.walk(path):
            root = root.replace("\\", "/")    # windows系统运行要解决这个bug
...
if __name__ == "__main__":
    data_name = "leather"
    train_data_path = "D:/datasets/mvtec_anomaly_detection/"+ data_name + "/train"
    test_data_path = "D:/datasets/mvtec_anomaly_detection/" + data_name + "/test"
